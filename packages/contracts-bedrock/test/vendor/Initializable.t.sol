    ...
    function setUp() public override {
        ...
        contracts.push(
            InitializeableContract({
                ...
                initCalldata: abi.encodeCall(
                    l1ERC721Bridge.initialize, (l1CrossDomainMessenger, address(l2ERC721Bridge), superchainConfig)
                    ),
        ...
        contracts.push(
            InitializeableContract({
                ...
                initCalldata: abi.encodeCall(l2ERC721Bridge.initialize, (l2CrossDomainMessenger, address(l1ERC721Bridge))),
